 ...
 * @endcode
 */
$settings['hash_salt'] = '3LBAX-DzyF_oHTrSRRNUNUhKtBcY_M9cTHicsVdn8QZQ9f282dJvipyLa5BPkMYWbQKollCKSw';
...
if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_ows_dev_dd.inc')) {
  require $_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_ows_dev_dd.inc';
}
// </DDSETTINGS>
$databases['default']['default'] = array (
  'database' => 'ows',
