...
jQuery(document).ready(function() {
    jQuery('.page-free-quote .view-products .views-exposed-widgets').append('<div style="float:right;margin-top: 40px;"><a class="q-button" id="btn-add" type="button" value="Add to list" href="#add-to-list">Add to list</a><a id="btn-my-quote" type="button" value="My Quote" href="/my-quote">My Quote</a><a id="btn-submit-quote" type="button" value="Submit Quote" href="#quote-form">Submit Quote</a></div><div style="display:none;"><div class="quote-form" id="quote-form"><form id="form-quote-form" name="form-quote-form"><div class="form-item"><span class="label">Full name:</span> <input type="text" name="full_name" id="edit_full_name" required></div><div class="form-item"><span class="label">Email:</span> <input type="email" name="email" id="edit_email" required></div><div class="form-item"><span class="label">Comment: </span><textarea id="comment"></textarea></div><div class="form-item"><span class="label">&nbsp;</span><input type="submit" value="Submit" id="submit-quote-button"></div></form></div></div>');
        ...
        //if ($form.valid()) {
            ...
            if (product_ids != "") {
                jQuery.ajax({
                    ...
                    type: "POST",
                    data: 'ids=' + product_ids + '&quantities=' + quantities + '&name=' + jQuery('.quote-form #edit_full_name').val() + '&email=' + jQuery('.quote-form #edit_email').val() + '&comment=' + encodeURIComponent(jQuery('.quote-form #comment').val()),
                    dataType: 'json',
                    async: false,
    ...
    var $form2 = jQuery('#form-quote-form2').validate({
        rules: {
            full_name: "required",
            email: {
                required: true,
